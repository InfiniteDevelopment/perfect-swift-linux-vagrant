...
# tar -zxvf swift-2.2-SNAPSHOT-2016-01-06-a-ubuntu15.10.tar.gz &> /dev/null
    config.vm.define :"perfect-swift-linux-vagrant" do |config|
        config.vm.provider "virtualbox" do |v|
          v.name = "swift-linux-perfect"
        end
        ...
        cd /vagrant && git clone https://github.com/PerfectlySoft/PerfectStarter.git --recursive
